...
/// Text-only, tool-free comparison input. Credentials are resolved on the server.
...
/// Safe model catalog for the comparison page (no credentials or endpoint URLs).
#[derive(Debug, Clone, Serialize, Deserialize)]
pub struct ModelBenchModel {
