...
describe('AssistantSelectionArea', () => {
  ...
  it('shows the branded name for the built-in butler without changing its id', () => {
    render(
      <ConfigProvider>
        <AssistantSelectionArea
          selectedAssistantId='aionui-assistant'
          assistants={[overflowAssistant('aionui-assistant', 'AionUi管家', 1)]}
          localeKey='zh-CN'
          onSelectAssistant={vi.fn()}
        />
      </ConfigProvider>
