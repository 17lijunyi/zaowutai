...
describe('titleForPath', () => {
  ...
  it('uses the login title on the login route only', () => {
    ...
    expect(titleForPath('/guid', t)).toBe(APP_DISPLAY_NAME);
    expect(titleForPath('/conversation/abc', t)).toBe(APP_DISPLAY_NAME);
    expect(titleForPath('/settings/agent', t)).toBe(APP_DISPLAY_NAME);
  });
});

describe('DocumentTitle', () => {
  it('resets the title to the custom product name after leaving the login page', () => {
