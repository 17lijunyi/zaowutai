...
import { brandLocaleResource } from '@/common/branding';
...
import { resolveConfiguredLanguage, resolveInitialLanguage } from './startupLanguage';
...
const localeData: LocaleData = brandLocaleResource({
  'en-US': enUS,
  'zh-CN': zhCN,
  'ja-JP': jaJP,
  'zh-TW': zhTW,
...
function getInitialLanguage(): SupportedLanguage {
  ...
  return resolveInitialLanguage({
    backendStartupFailed: Boolean(backendStartupFailed),
    localStorageLanguage: getLocalStorageLanguageHint(),
...
async function initLanguage(): Promise<void> {
  try {
    ...
    const language = resolveConfiguredLanguage(savedLanguage);
