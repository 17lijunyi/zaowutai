    ...
    <Alert
      ...
      content={
        <Space direction='vertical' size='medium' style={{ width: '100%' }}>
          <Paragraph>
            <Text bold>
              OpenClaw is handling {platformName} messages, not {APP_DISPLAY_NAME}.
            </Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <ul>
              <li>
                <Text type='error'>✗ Switching agents in {APP_DISPLAY_NAME} will have no effect</Text>
              </li>
              <li>
          ...
          <Paragraph>
            <Text bold>To use {APP_DISPLAY_NAME} Channels and switch agents:</Text>
          </Paragraph>
          ...
          <Paragraph>
            ...
            <br />
            Then restart OpenClaw and {APP_DISPLAY_NAME}.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 2: Use a different bot</Text>
            <br />
            Create a new {platformName} bot with different credentials for {APP_DISPLAY_NAME}.
          </Paragraph>

          <Paragraph>
            <Text type='secondary'>Option 3: Keep using OpenClaw</Text>
            <br />
            Disable {platformName} in {APP_DISPLAY_NAME} Channels and continue using OpenClaw's integration.
          </Paragraph>
