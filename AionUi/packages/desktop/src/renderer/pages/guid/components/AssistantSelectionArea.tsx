...
const AssistantSelectionArea: React.FC<AssistantSelectionAreaProps> = ({
  ...
  const renderAssistantPill = (assistant: Assistant, testId: string, fullWidth = false) => {
    ...
    const label = replaceUpstreamBrand(assistant.name_i18n?.[localeKey] || assistant.name);
  ...
  return (
    <div ref={containerRef} className='mt-18px mb-16px w-full'>
      <div className='flex w-full justify-center'>
        <div
          ref={barRef}
          className={`${styles.assistantBar} relative inline-flex max-w-full items-center rounded-999px px-6px py-6px`}
