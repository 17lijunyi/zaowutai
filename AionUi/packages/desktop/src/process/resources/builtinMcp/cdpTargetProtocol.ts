...
export const decideCdpCommand = (req: CdpRequest, getTargetInfo: () => TargetInfo): CdpDecision => {
  ...
  switch (method) {
    ...
    case 'Target.createTarget':
      return {
        kind: 'error',
        message: `${APP_DISPLAY_NAME} in-app browser exposes a single fixed tab; Target.createTarget is not supported.`,
      };
    ...
    case 'Target.disposeBrowserContext':
      return {
        kind: 'error',
        message: `${APP_DISPLAY_NAME} in-app browser does not support multiple browser contexts.`,
      };
    ...
    case 'Browser.close':
      return {
        kind: 'error',
        message: `Browser.close is not permitted against the ${APP_DISPLAY_NAME} in-app browser.`,
      };
